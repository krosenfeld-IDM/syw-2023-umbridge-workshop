...
param_dict['EXP_NAME']     = 'Workshop01'
param_dict['NUM_SIMS']     =  1500*3
...
# Daily import pressure
daily_import_pressures = [1, 10, 100]
param_dict['EXP_VARIABLE']['daily_import_pressure'] =      [daily_import_pressures[val] for val in np.random.randint(0,len(daily_import_pressures),size=NSIMS).tolist()]
