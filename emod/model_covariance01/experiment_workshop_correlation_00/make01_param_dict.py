...
param_dict['EXP_NAME']     = 'Workshop_correlation00'
...
param_dict['EXP_VARIABLE']['correlation_acq_trans']  =     np.random.uniform(low=0, high=1, size=NSIMS).tolist()
